export class URLSearchParam {
  public static objToUrlParams(obj: any) {
    console.log({ obj });
    const toUrlParams = (obj: any, prefix = '') => {
      // create url params
      let urlParams = '';
  ...
  public static checkIfObjShouldBeArrayAndConvert(obj: any) {
    // if obj is an array
  ...
  public static addObjToUrl(obj: any, url = window.location.href) {
